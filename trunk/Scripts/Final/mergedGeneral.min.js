...
$.fn.slideFadeToggle=function(b,a){return this.animate({opacity:"toggle",height:"toggle"},"fast",b,a)};function fnGetTodayDateString(){var b=new Date;return b.getFullYear()+"-"+(b.getMonth()<9?"0"+(b.getMonth()+1):b.getMonth()+1)+"-"+(b.getDate()<9?"0"+b.getDate():b.getDate())}
function fnGetDateString(b){var a=new Date,c=a.getFullYear(),d=a.getMonth()+1,e=fn2No(a.getMonth()+1);a=fn2No(a.getDate());return b==="ThisYear"?c+".01.01":b==="Last6M"?(d<6?c-1:c)+"."+(d<6?fn2No(d+6):fn2No(d-6))+"."+a:b==="Last12M"?c-1+"."+e+"."+a:c+"."+e+"."+a}function fnGetDateString_noDay(b){var a=new Date,c=a.getFullYear(),d=a.getMonth()+1;a=fn2No(a.getMonth()+1);return b==="ThisYear"?c+".01":b==="Last6M"?(d<6?c-1:c)+"."+(d<6?fn2No(d+6):fn2No(d-6)):b==="Last12M"?c-1+"."+a:c+"."+a}
function fn2No(b){return b<10?"0"+b:b}function fnGetStringFromjDate(){var b=new Date(parseInt(jsonDate.substr(6)));return[b.format("yy/mm/dd"),b.format("HH:MM")]}
function fnGetDateTime(b){var a=/^(\d{4})[\-|\/|\.]?(\d{1,2})[\-|\/|\.]?(\d{1,2})[\s\S]*(\d{2}:\d{2})$/;if(b!=""){if(regs=b.match(a)){if(regs[3]<1||regs[3]>31){alert("Invalid value for day: "+regs[1]);return false}if(regs[2]<1||regs[2]>12){alert("Invalid value for month: "+regs[2]);return false}if(regs[1]<1902||regs[1]>(new Date).getFullYear()){alert("Invalid value for year: "+regs[3]+" - must be between 1902 and "+(new Date).getFullYear());return false}}else{alert("Invalid date format: "+b);return false}return regs[1]+
"-"+regs[2]+"-"+regs[3]+" "+regs[4]+":00"}}Array.prototype.FNameIndex=function(b){for(var a=0;a<this.length;a++)if(this[a].FName==b)return a;return""};Array.prototype.findIndexByVal=function(b){for(var a=0;a<this.length;a++)if(this[a]==b)return a;return""};Array.prototype.findColsByID=function(b,a){for(var c=0;c<this.length;c++)if(this[c][0]===b)return typeof a==="object"?this[c].MapArrToString(a):this[c][a];return""};
Array.prototype.findRowByColValue=function(b,a){for(var c=0;c<this.length;c++)if(this[c][a]==b)return c;return""};Array.prototype.removeRowByID=function(b){for(var a=0;a<this.length;a++)if(this[a][0]===b){this.splice(a,1);return a}return""};Array.prototype.AddArray=function(b){for(var a=0;a<b.length;a++)this[this.length]=b[a]};Array.prototype.IndexOfFunc=function(b){for(var a=0;a<this.length;a++)if(b(this[a]))return a;return-1};
function ArrayIndexOf(b,a){if(!a||typeof a!="function")return-1;if(!b||!b.length||b.length<1)return-1;for(var c=0;c<b.length;c++)if(a(b[c]))return c;return-1}Array.prototype.ValueInMe=function(b){for(var a=0;a<this.length;a++)if(this[a]===b)return true;return false};Array.prototype.findColValByColVal=function(b,a,c){for(var d=0;d<this.length;d++)if(this[d][a]==b)return this[d][c];return""};Array.prototype.MapArrToString=function(b){for(var a=[],c=0;c<b.length;c++)a[a.length]=this[b[c]];return a.join(", ")};
Array.prototype.UpdateArrToNew=function(b){for(var a=0;a<this.length;a++)if(this[a][0]===b[0]){this[a]=b;return}};String.prototype.IsImage=function(){var b=this.substring(this.search("\\.")+1).toUpperCase();if(b==="PNG"||b==="JPG"||b==="GIF"||b==="JPEG"||b==="BMP")return true;return false};String.prototype.format=function(){for(var b=this,a=arguments.length;a--;)b=b.replace(RegExp("\\{"+a+"\\}","gm"),arguments[a]);return b};
String.prototype.GetIcon=function(b){var a=this.search("\\.");ret="<span style='display:inline-block;' class='{0} ui-button-icon-primary'>";img="img32-Help";if(a>0){a=this.substring(this.search("\\.")+1).toLowerCase();if(a==="png"||a==="jpg"||a==="gif"||a==="jpg"||a==="jpeg"||a==="bmp"){ret="<a href='/Uploads/"+b+"."+a+"' target='_blank'>"+ret+"</a>";img="img32-Img"}else if(a==="xls"||a==="xlsx")img="img32-Excel";else if(a==="pdf")img="img32-Pdf";else if(a==="ppt"||a==="pptx")img="img32-ppt";else if(a===
"doc"||a==="docx")img="img32-Word"}else if(this==="Add")img="img32-"+this.toString();return ret.format(img)};String.prototype.endsWith=function(b){return this.substr(this.length-b.length)===b};String.prototype.startsWith=function(b){return this.substr(0,b.length)===b};
...
(function(){var d,j,k,l,i,g;g={};k=$("#header div.subHeader a.highlight").data("controller");d="";$(function(){l();return $("#side-bar li>a").first().trigger("click")});l=function(){return $("#side-bar").on("click","li>a",function(){var a,c;$("body").addClass("wait");$("#side-bar a.highlight").removeClass("highlight");$(this).addClass("highlight");window.oGLOBAL.Action=$(this).data("action");if($(this).data("opt")==="refresh"){a=true;$(this).data("opt","ok")}else a=false;c="/"+k+"/"+(d=$(this).data("action"));
g[d]&&!a?i(g[d][0]):j(c,"");return $("body").removeClass("wait")})};j=function(a,c,b){if(b==null)b=$("#main-copy");b.parent().block();return $.ajax({url:a,type:"POST",data:c,dataType:"json",error:function(){b.html("<center><h2>\u0160i dalis dar nebaigta("+d+")</h2><img src='/Content/images/UnderConstruction.gif' alt=''/></center>");return b.parent().unblock()},success:function(e){i(e,b);if(g[d])g[d].push(e);else g[d]=[e];b.parent().unblock();return false}})};i=function(a,c){var b;if(c==null)c=$("#main-copy");
a.Render&&c.empty().html(a.Render);for(b in a)b!=="Render"&&b!=="Script"&&!oDATA.Get[b]&&this.oDATA.Set(b,a[b]);if(d==="Contracts_New_Other")return Contracts_New_Other();else if(d==="Clients_NewClient")return Clients_NewClient();else if(d==="Contracts_New_Object")return Contracts_New_Object();else if(d==="Contracts_Unsigned"){if(a.Script.oSCRIPT)this.oSCRIPT=a.Script.oSCRIPT;return ContractsUnsigned_Grid()}else if(d==="Contracts_Other"||d==="Contracts_Expired"){if(a.Script.oSCRIPT)this.oSCRIPT=a.Script.oSCRIPT;
return ContractsOther_Grid()}else if(d==="Contracts_Objects"){if(a.Script.oSCRIPT)this.oSCRIPT=a.Script.oSCRIPT;return ContractsObjects_Grid()}else if(d==="MyEvents")return Title_MyEvents();else if(d==="ClientsList")return Clients_ClientsList_Grid();else if(a.Script){a.Script.File&&$.getScript(a.Script.File);if(a.Script.oSCRIPT)return this.oSCRIPT=a.Script.oSCRIPT}};Array.prototype.remove=function(a){var c;if((a=this.indexOf(a))>-1)return[].splice.apply(this,[a,a-a+1].concat(c=[])),c};this.oDATA=
{Obj:{},Set:function(a,c){return this.Obj[a]=c},Get:function(a){return this.Obj[a]},UpdateRow:function(a,c,b){if(b==="Edit"){this.GetRow(a[0],c);return a}else if(b==="Add")return this.GetData(c).push(a);else if(b==="Delete")return this.GetData(c).remove(a)},GetRow:function(a,c){var b,e,f,h;b=this.GetData(c);e=b.length-1;f=-1;for(h=[];f<e;){f++;if(b[f][0]===a)return b[f];else h.push(void 0)}return h},GetData:function(a,c){return typeof a==="string"?c?this.Obj[a].Cols:this.Obj[a].Data:a.Data},GetStringFromIndexes:function(a,
c,b){return this.GetRow(a,c).MapArrToString(b)},UpdateCell:function(a,c,b,e,f){var h;h=typeof e==="number"?e:oDATA.Get(a).Cols.FNameIndex(e);typeof e==="number"&&c&&alert("Updatinimui reikalingas lauko pavadinimas");this.GetRow(b,a)[h]=f;if(c)return $.post("/Update/editInPlace",{id:b,tbl:c,update_value:f,field:e})}}}).call(this);
...
(function(){this.clsEditableForm=function(){function l(c){var h,i,j,f;$("body").css("cursor","wait");b.Title=0;$.extend(b,c);o=b.aRowData!=null?b.aRowData[0]:0;e=oDATA.Get(b.objData);k=b.Action;e==null&&alert("Neradau objekto "+b.objData+" clsEditableForm klaseje");a={Cols:e.Cols,Grid:e.Grid,Data:b.aRowData};if(o&&a.Data==null){f=e.Data;i=0;for(j=f.length;i<j;i++){c=f[i];if(c[0]===o){a.Data=c;break}}}if(!b.Title){d=e.Config;b.Title=k==="Add"?d.Msg.AddNew:d.Msg.Edit;if(d.Msg.AddToTitle&&k==="Edit"){c=
function(){var m,p,q,r;q=d.Msg.AddToTitle;r=[];m=0;for(p=q.length;m<p;m++){h=q[m];r.push(a.Data[h])}return r}();b.Title+=" - "+c.join(" ")}}this.fnLoadEditableForm();$("body").css("cursor","default")}var k,d,a,g,n,o,e,b;o=0;e={};d={};a={};e={};k={};b={DialogFormId:"divDialogForm",fnAddNewForm:"Dialog",CallBackAfter:0,aRowData:0};l.prototype.fnLoadEditableForm=function(){var c,h,i;if(!b.form||b.form==="Dialog"){c={autoOpen:false,minWidth:"45em",minHeight:"40em",width:"60em",modal:true,title:b.Title,
...
b.target.css("display","block");return b.form.empty()};n=function(){var c;if(c=oGLOBAL.ValidateForm($("#divEditableForm")))return oGLOBAL.UpdateServer({Action:k,DataToSave:c,CallBack:{Success:function(h,i){var j,f,m,p,q;m=a.Cols.length;f=0;p=i.DataToSave.Fields.length;if(k==="Add"){a.Data=Array(m);a.Data[0]=h.ResponseMsg.ID}for(;f<m-1;){j=q=0;for(f++;q<p;){if(a.Cols[f].FName===i.DataToSave.Fields[q]){a.Data[f]=i.DataToSave.Data[q];j=1;break}q++}if(!j&&k==="Add")if(a.Cols[f].Default!=null)a.Data[f]=
a.Cols[f].Default==="Today"?fnGetTodayDateString():a.Cols[f].Default==="UserName"?UserData.Name():a.Cols[f].Default==="UserId"?UserData.Id():a.Cols[f].Default;else if(a.Cols[f].UpdateField){j=a.Cols[f].UpdateField;a.Data[f]=i.DataToSave[j]}else a.Data[f]="";if(a.Data[f]===null)a.Data[f]=""}for(f=0;f<m-1;){f++;if(a.Cols[f].IdInMe){j=a.Cols[f].IdInMe;o=a.Data[j];p=a.Cols[j].List.Source;j=a.Cols[j].List.iText;a.Data[f]=oDATA.GetStringFromIndexes(o,p,j)}}oDATA.UpdateRow(a.Data,e,k);b.CallBackAfter&&b.CallBackAfter(a.Data);
return!b.form||b.form==="Dialog"?$("#"+b.DialogFormId).dialog("close"):g()}},Msg:"",BlockCtrl:$("#divEditableForm")});else if(c===0)return $("#"+b.DialogFormId).dialog("close")};l.prototype.fnGenerateHTML=function(c,h){var i,j,f,m,p;j=c.Cols.length;m=0;for(f="";m<j;){i="";if(c.Grid.aoColumns[m].sTitle!=null){if(c.Data[m]!=null&&c.Data[m]){p=c.Cols[m].Type?c.Cols[m].Type:"";p=p==="String"||p==="Email"||p.substring(0,4)==="Date"?'"'+c.Data[m].replace(/"/g,"\\u0027")+'"':c.Data[m]}else p='""';i+='"Value":'+
p+",";f+="<div class='ExtendIt' data-ctrl='{"+i+'"Field":"'+c.Cols[m].FName+'","classes":"UpdateField","labelType":"Left"}\'></div>'}m++}i=h!=null?'"NewRec":0,"id":'+h+",":'"NewRec":1,';i+='"Source":"'+(d.Source?d.Source:d.tblUpdate)+'","tblUpdate":"'+d.tblUpdate+'"';return"<div id='divEditableForm' class='inputform' style='margin:0 2em;' data-ctrl='{"+i+"}'>"+f+"</div>"};return l}();this.clsEditInPlaceForm=function(){var l,k,d;d={};l={Fields:[],Data:[],id:0,DataTable:""};k=function(a,g,n,o,e){var b;
b=null;e=e!=null?e:{};$.extend(e,{"U\u017edaryti":function(){d.fnFieldsUpdatedCallBack&&l.Data&&d.fnFieldsUpdatedCallBack(l);return $(this).remove()}});a={autoOpen:false,position:["center",50],resize:"auto",minWidth:"45em",width:"65em",modal:true,title:a,draggable:true,buttons:e,close:function(){d.fnFieldsUpdatedCallBack&&l.Data&&d.fnFieldsUpdatedCallBack(l);return $(this).remove()},dragStart:function(){return $("div.validity-modal-msg").remove()}};$("<div id='divDialogForm' style='overflow:auto'></div>").html(g).ModifyDoom({tblProp:n,
EditableFormId:o},l,d.fnUpdateSuccess).dialog(a).dialog("open").css("height","auto");if(d.Grid)return b=$("#"+d.Grid.DoomId).clsGrid(d.Grid.Opt,d.Grid.Source)};return function(a){$("body").addClass("wait");d=a;$.post(d.url,d.postPars,function(g){var n;for(n in g)n!=="Render"&&n!=="Script"&&oDATA.Set(n,g[n]);g.Script&&g.Script.File&&$.getScript(g.Script.File);g.Render?k(d.formTitle,g.Render,d.tblProp,d.EditableFormId,d.Buttons):alert("clsEditInPlaceForm nera Render objekto!");return $("body").removeClass("wait")})}}();
$.fn.ModifyDoom=function(l,k,d){var a,g;g=this.find("#"+l.EditableFormId);a=eval("("+g.attr("data-ctrl")+")");k.id=a.id;k.DataTable=a.tblUpdate;g.find("div.EditInPlace, span.EditInPlace").each(function(){return $(this).MyEditInPlace({id:a.id,tblUpdate:a.tblUpdate,tblProp:l.tblProp,DataToSave:k,fnUpdateSuccess:d})});return this};$.fn.MyEditInPlace=function(l){var k,d,a,g,n,o;g=$(this);k=g.html();(a=typeof g.data("ctrl")==="object"?g.data("ctrl"):eval("("+g.attr("data-ctrl")+")"))||(a={});$.extend(a,
l,{FName:a.Field});if(l.tblProp){o=oDATA.Get(l.tblProp);d=o.Cols.FNameIndex(a.Field);a=$.extend({},o.Cols[d],a);$.extend(a,{Title:o.Grid.aoColumns[d].sTitle})}n=function(e,b){g.html('<img src="/Content/images/ajax-loader.gif" alt='+e+">");return $.post("/Update/editInPlace",{id:a.id,tbl:a.tblUpdate,update_value:e,field:a.Field,show_value:b},function(c){if(c.ErrorMsg){Alert(c.ErrorMsg,"Klaida i\u0161saugant duomenis");return g.html(k)}else{g.html(c.ResponseMsg);k=c.ResponseMsg;if(l.DataToSave){l.DataToSave.Data.push(c.ResponseMsg);
l.DataToSave.Fields.push(a.Field)}if(l.fnUpdateSuccess)return l.fnUpdateSuccess({ctrl:g,eOpt:a,id:a.id})}})};d={didOpenEditInPlace:function(e){var b;e.attr("width",e.width());b=e.width()<200?200:e.width();return e.find("textarea, input").width(b)}};if(a.List)d.shouldOpenEditInPlace=function(e){var b;if(e.find("input").length>0)return false;b=oCONTROLS.txt({data_ctrl:JSON.stringify($.extend(a.List,{FName:a.FName})),classes:"ui-widget-content ui-corner-all",text:e.html(),Value:e.html()});e.html(b).find("input").ComboBox({fnValueChanged:function(c,
h){return n(c,h)}}).focus().bind("blur",function(){var c;return c=setInterval(function(){var h;h=$("ul.ui-autocomplete").css("display");if(h==="none"||h===void 0){g.html(k);return clearInterval(c)}},3E3)});return false};else if(a.Plugin)d.shouldOpenEditInPlace=function(e){var b,c,h,i;if(e.find("input").length>0)return false;e.html("<input type='text'></input>");h=e.find("input");h.val(k);i=a.Plugin;for(b in i){c=i[b];if(b==="datepicker"){$.extend(c,{onClose:function(j){return n(j,null)}});h.attr("readonly",
"readonly")[b](c).focus()}else b==="mask"&&h[b](c).focus().bind("blur",function(j){return(j=$(j.target).mask("value"))&&j!==k?n(j,null):e.empty().html(k)})}return false};if(!a.id||!a.tblUpdate||!a.Field)alert("N\u0117ra privalom\u0173 duomen\u0173 (id, tblUpdate, Field)-clsEditableForm");$.extend(a,{delegate:d,callback:function(e,b){n(b,null);return'<img src="/Content/images/ajax-loader.gif" alt='+b+">"}});g.editInPlace(a);a.Title&&g.qtip({position:{at:"top center",my:"bottom center"},content:a.Title});
return g}}).call(this);
