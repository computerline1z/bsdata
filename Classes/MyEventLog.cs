...
namespace BSData.Classes {
    ...
    public class MyEventLog {
        ...
        public static void AddException(Exception e, bool SendMail = false) {
            ...
            catch (Exception ex) { MyEventLog.AddEvent(ex.Message + "" + ex.Data, "Klaida AddException1"); }
            try { if (SendMail) MailHelper.SendMailMessage("saulius@bs.lt", null, "justas@bs.lt", src, "Nepavyko išsiųst"); }
