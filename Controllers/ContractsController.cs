...
namespace BSData.Controllers {
    ...
    public class ContractsController : ToStringController {
        ...
        [HttpPost]
        public JsonResult Contracts_MyAll() {//Daryt pagal Contracts_MyNotFinished
            ViewBag.Title = "Galiojančios sutvarkytos mano sutartys";
            string View = RenderPartialViewToString("../Shared/Grid");
            Repository_Contracts Rep = new Repository_Contracts();
            var obj = new {
                Render = View,
                ...
                //   oSCRIPT = new { Editable = UserData.HasRole("UsersEdit") }
                //},
                tblContracts_Contracts_MyAll = Rep.GetJSON_proc_GetContracts(3, UserData.UserID, null)
            };
            return Json(obj);
        }
    }
