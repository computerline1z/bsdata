//namespace BSData.Providers {
//   public class BSMemProvider : MembershipProvider//sealed
//   {
...
//      public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status, string Position, DateTime Birthday, DateTime Work_from, int SubDepID, int DepID, int Phone) {
...
//      #endregion User related methods : create, update, unlock, delete methods.
...
//      #endregion User authentication methods
...
//      #endregion User information retreival methods
...
//      #endregion Private password helper methods
...
//         //BSData.Classes.UserData.SetParameters(U);
//      }
...
//      #endregion Create and Delete methods
...
//      #endregion Assign/Remove methods
